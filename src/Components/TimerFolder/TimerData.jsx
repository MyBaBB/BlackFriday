...
const Timer = () => {
  var countDownDate = new Date("november 21, 2024 00:00:00 PST").getTime();
  ...
  var x = setInterval(function () {
    ...
    if (distance < 0) {
      ...
      document.getElementById("demo").innerHTML =
        ...
        "<span class='timerStylesWrapper'>" +
        " <span class='timerStylesFinished1'>Shop&nbsp;</span>" +
        "<span class='timerStylesFinished2'>And&nbsp;</span>" +
        "<span class='timerStylesFinished3'>Drop</span>" +
        "</span>";
    }
  }, 1000);
};
